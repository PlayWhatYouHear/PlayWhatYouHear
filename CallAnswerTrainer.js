...
var Elm = {};
Elm['CallAnswerTrainer'] = Elm['CallAnswerTrainer'] || {};
if (typeof _user$project$CallAnswerTrainer$main !== 'undefined') {
    _user$project$CallAnswerTrainer$main(Elm['CallAnswerTrainer'], 'CallAnswerTrainer', undefined);
}
